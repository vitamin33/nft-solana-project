...
const CandyMachine = ({walletAddress}) => {
  const [candyMachine, setCandyMachine] = useState(null)
    ...
    const getCandyMachineState = async () => {
        ...
        const presale = candyMachine.data.whitelistMintSetttings
            && candyMachine.data.whitelistMintSetttings.presale
            && (!candyMachine.data.goLiveDate
                || !candyMachine.data.goLiveDate.toNumber() > new Date().getTime() / 10000)
